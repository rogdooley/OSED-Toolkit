#!/usr/bin/env python3
"""Run badchars_wds orchestrator from JSON config (no CLI package required)."""
...
def _parse_args():
    ...
    parser.add_argument("--config", default="config.badchars.json", help="Path to JSON config file.")
